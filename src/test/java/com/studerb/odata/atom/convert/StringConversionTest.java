...
public class StringConversionTest {
    ...
    public void stringToDecimalTest() {
        String decimal = "2.345";
        fail("Decimal not successfully created");
    }

    @Test
    public void stringToSByteTest() {
        fail("SByte not successfully created");
    }

    @Test
    public void stringToBigDecimalTest() {
        fail("BigDecimal not successfully created");
    }

    @Test
    public void stringToInt16Test() {
        fail("Short not successfully created");
    }

    public void stringToInt32Test() {
        fail("Integer not successfully created");
    }

    public void stringToInt64Test() {
        fail("Long not successfully created");
    }
